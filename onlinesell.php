...
<form name="form1" method="post" action="addonlinesell.php" onSubmit="return check(form1)">
...
<tr>
		<td>Phone num:</td>
		<td><input type="textbox" name="phnum" size=30></td>
	</tr>
<tr>
		<td>Product Name:</td>
		<td><textarea name="name" rows="15" cols="30">
		</textarea>
		</td>
	</tr>
